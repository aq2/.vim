...
" basic text
  ...
  exe 'hi NonText guifg='s:black' guibg='s:darker
...
"   line numbers and ui stuff
  ...
  exe 'hi VertSplit guifg='s:black' guibg='s:darker
...
" messages
  ...
  exe 'hi Error guifg='s:black' guibg='s:pink' gui=bold'
  exe 'hi ErrorMsg guifg='s:black' guibg='s:pink' gui=bold'
