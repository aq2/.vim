...
let s:p.insert.right = [ [ s:purple, s:orange ], [ s:white, s:dgray ], [ s:white, s:purple ] ]
let s:p.visual.right = [ [ s:purple, s:orange ], [ s:white, s:dgray ], [ s:white, s:purple ] ]
let s:p.replace.right = [ [ s:purple, s:orange ], [ s:white, s:dgray ], [ s:white, s:purple ]  ]
